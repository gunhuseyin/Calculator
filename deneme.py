...
# Define the Calculator class inheriting from QMainWindow
class Calculator(QMainWindow):
    ...
    def load(self):
        ...
        # Create a new Layout for the buttons section
        main_vb = QVBoxLayout()
        ...
        minusBtn.resize(45, 45)
        minusBtn.setMinimumSize(45, 45)
        minusBtn.setMaximumSize(45, 45)
        minusBtn.setStyleSheet("background-color:#a0a0a0; border-radius:22px; color:black;")
        minusBtn.clicked.connect(self.addAction)
        gridLayout.addWidget(minusBtn, 1, 3)
    ...
    # Function to handle the delete (backspace) button click
    def delAction(self):
    ...
    # Function to handle the equal button click (perform the calculation)
